        ...
        <div class="flex flex-col gap-2">
            <UCard style="width: 100%;">
                ...
                <div class="flex items-center gap-2">
                    <UInput v-model="account_pk" placeholder="Public Key" class="flex-1" />
                ...
                SecretKey:
                <UInput v-model="account_sk" placeholder="Secret Key" disabled />

                Select An Identity:
                <USelect option-attribute="label" v-model="selectedIdentityIndex" :options="selectIdentityOptions"
                    label="Select An Identity" placeholder="Choose one" />
                <small>Identity Index: {{ selectedIdentityIndex }}</small>
                <br>
                <small>Credential Index: <UButton @click="decreseCredIndex">-</UButton></small> {{ credIndex }} <UButton
                    @click="incrementCredIndex">+</UButton>
                <br>
                ...
                <br>
                AccountAddress:
                <UInput v-model="account_address" placeholder="Account Address" />
...
const generateAccountKeys = () => {
    ...
    const identityProviderIdentity = 0 // TODO: hardcoded
